...
export default function BenefitsPage() {
  ...
  const filteredItems = benefits.filter(item =>
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">จัดการข้อมูลสิทธิประโยชน์พิเศษ</p>
        </div>
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>
              {editingItem ? 'แก้ไขสิทธิ์ประโยชน์' : 'เพิ่มสิทธิ์ประโยชน์ใหม่'}
            </DialogTitle>
          </DialogHeader>
          <div className="space-y-4 py-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="กรอกรายละเอียดสิทธิ์ประโยชน์"
              />
            </div>
            <div className="space-y-2">
